...
Feature: Login feature
  ...
  Scenario Outline: Verify Invalid Login for multiple users
   ...
   @login-5
   Scenario Outline: Verify error message for Invalid Email
     When I enter Vish into firstname text field on home screen
     And I enter Mang into lastname text field on home screen
     And I enter <email> into email text fields on home screen
     And I click on password text field on home screen
     And I click on red warning button on home scrren
     Then I verify Error Message for Invalid Email
